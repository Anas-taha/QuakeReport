    ...
    public static ArrayList<earthquake> extractEarthquakes() {
        ...
        try {
            ...
            for (int i = 0 ; i<earthquakeArray.length();i++){
                ...
                JSONObject propertiesJson = currentEarthquake.getJSONObject("properties");
                double mag = propertiesJson.getDouble("mag");
                String place= propertiesJson.getString("place");
                long timeInms = propertiesJson.getLong("time");
                String url = propertiesJson.getString("url");

                earthquake earthquake = new earthquake(mag, place,timeInms,url);
